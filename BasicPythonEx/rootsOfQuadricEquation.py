...
def rootsOfEquation():
    a = 5 #int(input("Please Enter a Value of a Quadratic Equation : "))
    b = 4 #int(input("Please Enter b Value of a Quadratic Equation : "))
    c = 3 #int(input("Please Enter c Value of a Quadratic Equation : "))
